// Header file acting as a centralized definition for all peripheral base addresses and fundamental constants.
#pragma once
#include <stdint.h>

/* MCU DEFINITIONS (XMC1100) */

// Clock definitions for the firmware assumptions.
...
// connected to the on-chip peripheral units. (of course, some of them shouldn't be exposed out of the pcb.)
#define PORT0_BASE 0x40040000UL
#define PORT1_BASE 0x40040100UL // high current bi-directional pad
#define PORT2_BASE 0x40040200UL 
#define USIC0_CH0_BASE 0x48000000UL // for I2C, end address 480001FFH
#define USIC0_CH1_BASE 0x48000200UL // for SPI, end address 480003FFH
#define SYST_BASE 0xE000E000UL // M0 SysTick Timer Base 
...
#define SCU_CGATSTAT0 (*(volatile uint32_t*)(SCU_BASE + 0x308UL)) // clock‑gating status 0
#define SCU_CGATCLR0 (*(volatile uint32_t*)(SCU_BASE + 0x310UL)) // clock-gating clear (all bits protected)
#define SCU_CGATSET0 (*(volatile uint32_t*)(SCU_BASE + 0x30CUL)) // clock-gating set 0 (all bits protected)
...
#define P0_OMR (*(volatile uint32_t*)(PORT0_BASE + 0x04UL)) // Output Modification Register, preferred over the direct change of the output value with the output register Pn_OUT
