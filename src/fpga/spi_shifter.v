module spi_byte_shifter #(
    ...
    input wire mosi_oe,   // drive MOSI when 1,output enable
    ...
    reg [7:0] shreg; //shift register, data shifted out. 
    reg [3:0] bitcnt; //how many bits have already transmitted
    reg [$clog2(CLK_DIV*2)-1:0] divcnt; //clock divider counter to be able to count up to CLK_DIV*2-1
